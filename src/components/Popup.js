                        ...
                        <div className="favorites-container">
                            <div onClick={this.setType} data-type='work' data-ref="safariWork" className="fave-c">
                                <div data-type='work' data-ref="safariWork" className="fave-icon">
                                    ...
                                    <div data-type='work' data-ref="safariWork" className="fave-text">{this.props.language === 'en' ? 'Work' : '工作'}</div>
                            </div>
    ...
    renderSafari  = () => (
        <div
            ...
            <div className="top-bar">
                ...
                <input type="text" placeholder={this.props.language === 'en' ? "Search or enter a website" : '搜索或输入网站'} onKeyPress={this.onInput} className="safari-search" />
